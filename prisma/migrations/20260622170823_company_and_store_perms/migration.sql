...
-- AddForeignKey
ALTER TABLE "financial_entries" ADD CONSTRAINT "financial_entries_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "stores"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
